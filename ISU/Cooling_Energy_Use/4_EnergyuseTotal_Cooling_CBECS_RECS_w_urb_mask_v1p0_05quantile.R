...
fname <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_CONUS_CoolingElecUse_", Quanitle_level ,"_nonUHI_Full.tif")
CBECS_Cooling_nonUHI <- raster::raster(fname)

fname <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_CONUS_CoolingElecUse_", Quanitle_level ,"_UHI_Full.tif")
CBECS_Cooling_UHI <- raster::raster(fname)

fname <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_CONUS_CoolingElecUse_", Quanitle_level ,"_nonUHI_Full.tif")
RECS_Cooling_nonUHI <- raster::raster(fname)

fname <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_CONUS_CoolingElecUse_", Quanitle_level ,"_UHI_Full.tif")
...
# Save Rasters
fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse_diff_Percent/Cooling/UK_Estimations/CBECS_CONUS_percent_diff_Cooling_Energy_", Quanitle_level ,".tif")
writeRaster(CBECS_percent_diff_Cooling_Energy, filename = fname_ras, overwrite = TRUE)
fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse_diff_Percent/Cooling/UK_Estimations/RECS_CONUS_percent_diff_Cooling_Energy_", Quanitle_level ,".tif")
...
imagefname <- paste0("2_output/Energyuse_Script/NNR_RAW/Paper_Images/CoolingEnergy_and_Diff_CenDiv500m_", Quanitle_level ,".jpg")
...
summary_CBECS_sum_Cooling_Energy %>% mutate(PercentDiff = (Difference / UHI) * 100) %>% 
  write.csv(paste0("2_output/Energyuse_Script/NNR_RAW/Paper_Images/CoolingEnergy_CBECS_and_Diff_CenDiv500m_", Quanitle_level ,".csv"))
summary_RECS_sum_Cooling_Energy %>% mutate(PercentDiff = (Difference / UHI) * 100) %>% 
  write.csv(paste0("2_output/Energyuse_Script/NNR_RAW/Paper_Images/CoolingEnergy_RECS_and_Diff_CenDiv500m_", Quanitle_level ,".csv"))
...
# grid.arrange(p1, p2, nrow = 2)
imagefname <- paste0("2_output/Energyuse_Script/NNR_RAW/Paper_Images/CoolingEnergy_Percent_Diff_CenDiv500m_", Quanitle_level ,".jpg")
jpeg(filename = imagefname, width = 10, height = 8, units = "in", bg = "white", res = 320)
grid.arrange(p1, p2, nrow = 2)
dev.off()

save.image(file = paste0("EnergyuseTotal_Cooling_CBECS_RECS_w_urb_mask_", Quanitle_level ,".RData"))
