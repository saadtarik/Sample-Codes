...
library(leaflet)
library(sp)
# outline_test <- readOGR("Z:/Saad/Data_Repository/US_States", "CONUS_states_w2009RECSdomainDissolve_prj")
...
for (k in 1:length(nregions)) {
  ...
  coef_medintensity_cbecs <- c(cbecs_qreg_intercepts_region$Q05, cbecs_qreg_slopes_region$Q05,
                               cbecs_qreg_Covariates_slopes_region_bldgType$Q05, cbecs_qreg_Covariates_slopes_region_people$Q05,
                               cbecs_qreg_Covariates_slopes_region_bldgYrCons$Q05)
  coef_medintensity_recs <- c(recs_qreg_intercepts_region$Q05, recs_qreg_slopes_region$Q05,
                              recs_qreg_Covariates_slopes_region_bldgType$Q05, recs_qreg_Covariates_slopes_region_people$Q05,
                              recs_qreg_Covariates_slopes_region_bldgYrCons$Q05)
  ...
  fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_", k, "_CoolingElecUse_Q05_UHI_Full.tif")
  writeRaster(median_energy_cbecs_ras_uhi, filename = fname_ras, overwrite = TRUE)
  fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_", k, "_CoolingElecUse_Q05_UHI_Full.tif")
  writeRaster(median_energy_recs_ras_uhi, filename = fname_ras, overwrite = TRUE)
  fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_", k, "_CoolingElecUse_Q05_nonUHI_Full.tif")
  writeRaster(median_energy_cbecs_ras_nonuhi, filename = fname_ras, overwrite = TRUE)
  fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_", k, "_CoolingElecUse_Q05_nonUHI_Full.tif")
  writeRaster(median_energy_recs_ras_nonuhi, filename = fname_ras, overwrite = TRUE)

  ## For Q95 ##
  
  coef_medintensity_cbecs <- c(cbecs_qreg_intercepts_region$Q95, cbecs_qreg_slopes_region$Q95,
                               cbecs_qreg_Covariates_slopes_region_bldgType$Q95, cbecs_qreg_Covariates_slopes_region_people$Q95,
                               cbecs_qreg_Covariates_slopes_region_bldgYrCons$Q95)
  coef_medintensity_recs <- c(recs_qreg_intercepts_region$Q95, recs_qreg_slopes_region$Q95,
                              recs_qreg_Covariates_slopes_region_bldgType$Q95, recs_qreg_Covariates_slopes_region_people$Q95,
                              recs_qreg_Covariates_slopes_region_bldgYrCons$Q95)
  ...
  fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_", k, "_CoolingElecUse_Q95_UHI_Full.tif")
  writeRaster(median_energy_cbecs_ras_uhi, filename = fname_ras, overwrite = TRUE)
  fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_", k, "_CoolingElecUse_Q95_UHI_Full.tif")
  writeRaster(median_energy_recs_ras_uhi, filename = fname_ras, overwrite = TRUE)
  fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_", k, "_CoolingElecUse_Q95_nonUHI_Full.tif")
  writeRaster(median_energy_cbecs_ras_nonuhi, filename = fname_ras, overwrite = TRUE)
  fname_ras <- paste0("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_", k, "_CoolingElecUse_Q95_nonUHI_Full.tif")
  writeRaster(median_energy_recs_ras_nonuhi, filename = fname_ras, overwrite = TRUE)
...
raster_fnames <- list.files("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations", 
                            pattern = "*CoolingElecUse_Q05_UHI_Full.tif", 
...
raster_fnames <- list.files("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations", 
                            pattern = "*CoolingElecUse_Q05_nonUHI_Full.tif", 
                            full.names = TRUE, recursive = TRUE)
...
fname_ras <- "2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_CONUS_CoolingElecUse_Q05_UHI_Full.tif"
...
fname_ras <- "2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_CONUS_CoolingElecUse_Q05_nonUHI_Full.tif"
...
fname_ras <- "2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_CONUS_CoolingElecUse_Q05_UHI_Full.tif"
...
fname_ras <- "2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_CONUS_CoolingElecUse_Q05_nonUHI_Full.tif"
writeRaster(RECS_Energyuse_nonUHI_raster, filename = fname_ras, overwrite = TRUE)


## Q95
raster_fnames <- list.files("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations", 
                            pattern = "*CoolingElecUse_Q95_UHI_Full.tif", 
                            full.names = TRUE, recursive = TRUE)
...
raster_fnames <- list.files("2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations", 
                            pattern = "*CoolingElecUse_Q95_nonUHI_Full.tif", 
                            full.names = TRUE, recursive = TRUE)
...
CBECS_Energyuse_UHI_raster <- do.call(mosaic, rast.list)
plot(CBECS_Energyuse_UHI_raster)
fname_ras <- "2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_CONUS_CoolingElecUse_Q95_UHI_Full.tif"
writeRaster(CBECS_Energyuse_UHI_raster, filename = fname_ras, overwrite = TRUE)
...
CBECS_Energyuse_nonUHI_raster <- do.call(mosaic, rast.list)
plot(CBECS_Energyuse_nonUHI_raster)
fname_ras <- "2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/CBECS_CenDiv_CONUS_CoolingElecUse_Q95_nonUHI_Full.tif"
writeRaster(CBECS_Energyuse_nonUHI_raster, filename = fname_ras, overwrite = TRUE)
...
RECS_Energyuse_UHI_raster <- do.call(mosaic, rast.list)
plot(RECS_Energyuse_UHI_raster)
fname_ras <- "2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_CONUS_CoolingElecUse_Q95_UHI_Full.tif"
writeRaster(RECS_Energyuse_UHI_raster, filename = fname_ras, overwrite = TRUE)
...
RECS_Energyuse_nonUHI_raster <- do.call(mosaic, rast.list)
plot(RECS_Energyuse_nonUHI_raster)
fname_ras <- "2_output/Energyuse_Script/NNR_RAW/Rasters_CBEC_RECS_Energyuse/Cooling/UK_Estimations/RECS_CenDiv_CONUS_CoolingElecUse_Q95_nonUHI_Full.tif"
writeRaster(RECS_Energyuse_nonUHI_raster, filename = fname_ras, overwrite = TRUE)
